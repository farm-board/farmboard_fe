  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.sectionText}>
        We are FarmSphere Dynamics LLC ("Company," "we," "us," "our"), a company registered in Colorado, United States.
      </Text>
      <Text style={styles.sectionText}>
        We operate the mobile application FarmBoard (the "App"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").
      </Text>
      <Text style={styles.sectionText}>
        You can contact us by email at support@farmspheredynamics.com.
      </Text>
      <Text style={styles.sectionText}>
        These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and FarmSphere Dynamics LLC, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.
      </Text>
      <Text style={styles.sectionText}>
      ...
      <Text style={styles.sectionText}>
        FarmSphere Dynamics LLC
      </Text>
      <Text style={styles.sectionText}>
        Broomfield, CO 80020
      </Text>
      <Text style={styles.sectionText}>
        support@farmspheredynamics.com
      </Text>
    </View>
  );
};
