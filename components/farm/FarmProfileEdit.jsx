...
export default function FarmProfileEdit() {
  ...
  const uploadImage = async (uri) => {
    try {
      ...
      let response = await axios.post(`https://farmboard-be-a01a77990d21.herokuapp.com/api/v1/users/${currentUser.id}/farms/upload_image`, formData, {
        headers: {
  ...
  const removeImage = () => {
    ...
    axios.delete(`https://farmboard-be-a01a77990d21.herokuapp.com/api/v1/users/${currentUser.id}/farms/delete_image`);
    setModalVisible(false);
  };
  ...
  const uploadGalleryImage = async (uri) => {
    try {
      ...
      // Upload image to Amazon S3
      let response = await axios.post(`https://farmboard-be-a01a77990d21.herokuapp.com/api/v1/users/${currentUser.id}/farms/upload_gallery_photo`, formData, {
        headers: {
          'Content-Type': 'multipart/form-data',
        },
      });
    ...
    Alert.alert(
      ...
      [
        ...
        },
        {
          text: 'Delete',
          onPress: () => {
            axios.delete(`https://farmboard-be-a01a77990d21.herokuapp.com/api/v1/users/${currentUser.id}/farms/delete_gallery_photo/${photoId}`);
  ...
  const fetchGalleryImages = () => {
    axios.get(`https://farmboard-be-a01a77990d21.herokuapp.com/api/v1/users/${currentUser.id}/farms/gallery_photos`)
