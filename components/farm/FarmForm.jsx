...
export default function FarmForm() {
  ...
  const handleSubmit = () => {
    ...
    axios.put(`https://walrus-app-bfv5e.ondigitalocean.app/farm-board-be2/api/v1/users/${currentUser.id}/farms`, { farm: {...data, setup_complete: true}}) 
    .then(response => {
  ...
  const fetchProfileImage = async () => {
    try {
      let response = await axios.get(`https://walrus-app-bfv5e.ondigitalocean.app/farm-board-be2/api/v1/users/${currentUser.id}/farms/image`);
